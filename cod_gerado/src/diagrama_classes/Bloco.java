...
public class Bloco implements Serializable {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_BLOCO_EXERCICIO) {
			this.exercicio = (diagrama_classes.Exercicio) owner;
		}
	}
	...
	@Id	
	@GeneratedValue(generator="DIAGRAMA_CLASSES_BLOCO_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="DIAGRAMA_CLASSES_BLOCO_ID_GENERATOR", strategy="native")	
	private int ID;
	
	@ManyToOne(targetEntity=diagrama_classes.Exercicio.class, fetch=FetchType.LAZY)	
	...
	private diagrama_classes.Exercicio exercicio;
	...
	public void setExercicio(diagrama_classes.Exercicio value) {
		this.exercicio = value;
	}
	
	public diagrama_classes.Exercicio getExercicio() {
		return exercicio;
	}
