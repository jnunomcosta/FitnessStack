...
public class Treinador implements Serializable {
	...
	@Id	
	@GeneratedValue(generator="DIAGRAMA_CLASSES_TREINADOR_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="DIAGRAMA_CLASSES_TREINADOR_ID_GENERATOR", strategy="native")	
	private int ID;
	...
	@Transient	
	public final diagrama_classes.AvaliacaoSetCollection avaliacoes_t = new diagrama_classes.AvaliacaoSetCollection(this, _ormAdapter, ORMConstants.KEY_TREINADOR_AVALIACOES_T, ORMConstants.KEY_MUL_ONE_TO_MANY);
