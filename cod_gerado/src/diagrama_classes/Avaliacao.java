...
public class Avaliacao implements Serializable {
	...
	@Id	
	@GeneratedValue(generator="DIAGRAMA_CLASSES_AVALIACAO_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="DIAGRAMA_CLASSES_AVALIACAO_ID_GENERATOR", strategy="native")	
	private int ID;
