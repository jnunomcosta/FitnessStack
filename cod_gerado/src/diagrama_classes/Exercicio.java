...
public class Exercicio implements Serializable {
	...
	@Id	
	@GeneratedValue(generator="DIAGRAMA_CLASSES_EXERCICIO_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="DIAGRAMA_CLASSES_EXERCICIO_ID_GENERATOR", strategy="native")	
	private int ID;
	...
	private diagrama_classes.Treinador criador_exercicio;
	...
	@Column(name="Conteudo_media", nullable=true)	
	...
	public void setCriador_exercicio(diagrama_classes.Treinador value) {
		this.criador_exercicio = value;
	}
	
	public diagrama_classes.Treinador getCriador_exercicio() {
