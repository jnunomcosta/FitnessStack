...
public class Utilizador implements Serializable {
	...
	private java.util.Set this_getSet (int key) {
		if (key == ORMConstants.KEY_UTILIZADOR_AGENDA) {
			return ORM_agenda;
		}
	...
	@Id	
	@GeneratedValue(generator="DIAGRAMA_CLASSES_UTILIZADOR_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="DIAGRAMA_CLASSES_UTILIZADOR_ID_GENERATOR", strategy="native")	
	private int ID;
	...
	@OneToMany(targetEntity=diagrama_classes.Marcacao.class)	
	...
	@Transient	
	public final diagrama_classes.MarcacaoSetCollection agenda = new diagrama_classes.MarcacaoSetCollection(this, _ormAdapter, ORMConstants.KEY_UTILIZADOR_AGENDA, ORMConstants.KEY_MUL_ONE_TO_MANY);
