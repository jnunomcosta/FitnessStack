...
public class AASIPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "AASI";
	...
	private AASIPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(diagrama_classes.Treino.class);
		aMetadataSources.addAnnotatedClass(diagrama_classes.Utilizador.class);
		aMetadataSources.addAnnotatedClass(diagrama_classes.Treinador.class);
		aMetadataSources.addAnnotatedClass(diagrama_classes.Exercicio.class);
		aMetadataSources.addAnnotatedClass(diagrama_classes.Bloco.class);
		aMetadataSources.addAnnotatedClass(diagrama_classes.Administrador.class);
		aMetadataSources.addAnnotatedClass(diagrama_classes.Marcacao.class);
		aMetadataSources.addAnnotatedClass(diagrama_classes.Avaliacao.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new AASIPersistentManager();
		}
