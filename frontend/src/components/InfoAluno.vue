    ...
    >
      ...
      <template v-slot:default="dialog">
        <v-card>
          ...
          <v-row align="center" justify="space-around" style="margin-top:70px; margin-left:100px; margin-right:100px">
             <v-col cols="12" md="8">
<template>
                    <v-sheet height="64">
                      <v-toolbar flat>
...
<v-card-actions>
            <v-spacer></v-spacer>
            <v-btn style= "margin-top:100px; margin-right:100px" color="#f95738" text @click="dialog.value = false">
              Confirmar
            </v-btn>
          </v-card-actions>
