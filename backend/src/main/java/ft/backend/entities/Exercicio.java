...
public class Exercicio implements Serializable {
	...
	private java.util.List<ConteudoMedia> ORM_conteudoMedia = new java.util.ArrayList<>();
	...
	public void setORM_ConteudoMedia(java.util.List<ConteudoMedia> value) {
		this.ORM_conteudoMedia = value;
	}
	
	public java.util.List<ConteudoMedia> getORM_ConteudoMedia() {
